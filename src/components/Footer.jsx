...
export default function Footer()
{
    return(
        ...
        <footer className="mt-auto p-5 w-100 bg-light">
                <div className="container">
                    <div className="row gap-4 gap-sm-0">
                        <div className="col-12 col-sm-6 d-flex flex-column align-items-start justify-content-start">
                            <div className="text-secondary fw-bold fs-5">Copyright</div>
                            <div className="text-secondary mt-3">Copyright &copy; 2023, Amp Store.</div>
        ...
        <footer className="footer py-2 bg-light d-flex justify-content-center align-items-center mt-5 fixed-bottom">
            <span className="text-muted">&copy; 2022 Amp Store. All rights reserved.</span>
        </footer>
    */}
            </footer>
